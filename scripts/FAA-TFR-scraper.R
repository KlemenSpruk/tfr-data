...
tfrDataMemory <- read.table("/home/klemen/s3-export/tfrData-export-memory.csv", sep=",", header=T, na.strings="")
...
if (nrow(tfrDataMemory) >= 1) {
    ...
    write.table(tfrDataMemory, file = "/home/klemen/s3-export/tfrData-export-memory.csv", append = FALSE, quote = TRUE, sep = ",", eol = "\n", na = "", dec = ".", row.names = FALSE, col.names = TRUE, qmethod = c("escape", "double"), fileEncoding = "utf8")
}
...
write.table(tfrDataNew, file = "/home/klemen/s3-export/tfrData-export-memory.csv", append = TRUE, quote = TRUE, sep = ",", eol = "\n", na = "", dec = ".", row.names = FALSE, col.names = FALSE, qmethod = c("escape", "double"), fileEncoding = "utf8")
